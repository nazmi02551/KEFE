...
from kefe_api.modules.content_config.registry_adapter import PublishedContentAuthoringRegistry
from kefe_api.modules.content_config.router import router as content_config_router
...
def create_app() -> FastAPI:
    ...
    content_configuration_service = ContentConfigurationService(
        content_configuration_repository,
    )
    content_authoring_service = ContentAuthoringService(
        content_authoring_repository,
        PublishedContentAuthoringRegistry(content_configuration_repository),
    )
    ...
    app.include_router(content_config_router)
    return app
