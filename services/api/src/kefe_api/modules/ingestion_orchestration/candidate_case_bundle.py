...
class AcceptedSourceBriefCandidateSeed:
    ...
    def as_mapping(self) -> dict[str, Any]:
        ...
        return {
            ...
            "source_brief_review_decision_id": str(
                self.source_brief_review_decision_id
            ),
            "source_brief_payload_hash": self.source_brief_payload_hash,
            "source_brief_normalized_artifact_id": str(
                self.source_brief_normalized_artifact_id
            ),
    ...
    def from_artifact(cls, artifact: NormalizedArtifact) -> AcceptedSourceBriefCandidateSeed:
        ...
        if value["schema_version"] != SEED_SCHEMA_VERSION:
            _fail("CANDIDATE_SEED_ARTIFACT_INVALID")
        config = CandidateCaseEditorialConfiguration.from_mapping(
            value["editorial_configuration"]
        )
        ...
        try:
            ...
            seed = cls(
                ...
                source_brief_review_decision_id=_uuid(
                    value["source_brief_review_decision_id"]
                ),
    ...
    def process(
        ...
        *,
        ...
        decision_payload = {
            ...
            "source_brief_review_decision_id": str(
                seed.source_brief_review_decision_id
            ),
                    ...
                    "questions": [
                        {
                            ...
                            "response_type": "SINGLE_CHOICE",
                            "response_schema": {
                                "options": list(config.response_options)
                            },
                            "is_active": True,
                            "is_required": True,
                            "sort_order": 0,
