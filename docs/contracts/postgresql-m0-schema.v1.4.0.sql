...
-- Scope: Case → Weigh → Commit → Reveal + durable outbox + guest identity + typed questions + private reasons
-- Derived from Alembic revisions 20260727_0001 through 20260727_0006.
