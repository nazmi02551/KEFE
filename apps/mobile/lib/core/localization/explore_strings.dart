...
extension KefeExploreStrings on KefeStrings {
  ...
  String get exploreTrendingWeighs =>
      _isTurkish ? 'Trend tartımlar' : 'Trending weighs';
  String exploreCaseCount(int count) =>
      _isTurkish ? '$count vaka' : '$count cases';
  ...
  String domainLabel(String domain) {
    return switch (domain) {
      ...
      'TECHNOLOGY' ||
      'TECHNOLOGY_AI' => _isTurkish ? 'Teknoloji & YZ' : 'Technology & AI',
      'SPORTS' => _isTurkish ? 'Spor' : 'Sports',
      'CIVIC' ||
      'CITY_PUBLIC_LIFE' => _isTurkish ? 'Kamusal yaşam' : 'Public life',
      'WORK_ECONOMY' ||
      'WORK_BUSINESS' => _isTurkish ? 'İş & Ekonomi' : 'Work & Economy',
      'EDUCATION' => _isTurkish ? 'Eğitim' : 'Education',
      'FAMILY_PARENTING' =>
        _isTurkish ? 'Aile & Ebeveynlik' : 'Family & Parenting',
