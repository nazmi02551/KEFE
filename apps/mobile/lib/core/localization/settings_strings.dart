...
extension KefeSettingsStrings on KefeStrings {
  ...
  String get languageSystem => _isTurkish ? 'Cihaz dilini kullan' : 'Use device language';
  String get languageTurkish => 'Türkçe';
  String get languageEnglish => 'English';
  String get appearanceTitle => _isTurkish ? 'Görünüm' : 'Appearance';
  String get themeSystem => _isTurkish ? 'Cihaz ayarını kullan' : 'Use device setting';
  String get themeLight => _isTurkish ? 'Açık' : 'Light';
  String get themeDark => _isTurkish ? 'Koyu' : 'Dark';
  String get privacyAndData => _isTurkish ? 'Gizlilik ve veriler' : 'Privacy and data';
  ...
  String get internalPreviewLabel => _isTurkish ? 'Dahili ürün önizlemesi' : 'Internal product preview';
}
