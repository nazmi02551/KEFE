...
abstract final class ExperienceHubStringCatalog {
  static const KefeLocaleResources resources = {
    'en': {
      ...
      'sports_body':
          'Judge a disputed sports decision using the same KEFE weigh journey.',
      ...
      'retry': 'Try again',
      'signal_title': 'Signals',
      'signal_body': 'View qualified collective decisions that have passed integrity thresholds.',
      'signal_action': 'View Signals',
      'impact_title': 'Impact',
    ...
    'tr': {
      ...
      'retry': 'Tekrar dene',
      'signal_title': 'Sinyaller',
      'signal_body': 'Butunluk esiklerini gecen nitelikli kolektif kararlari goruntuleyin.',
      'signal_action': 'Sinyalleri Goster',
      'impact_title': 'Etki',
