...
class PreviewCaseMediaRepository implements CaseMediaRepository {
  ...
  static const _assets = <String, _PreviewMediaSpec>{
    '22222222-2222-4222-8222-222222222222': _PreviewMediaSpec(
      ...
      alt: 'İki farklı ihtiyacı temsil eden karşılıklı iki figür ve aralarında KEFE terazisi.',
    ),
    '22222222-2222-4222-8222-222222222223': _PreviewMediaSpec(
      ...
      alt: 'Bir veri ağı, bağlantı düğümleri ve koruma kalkanını temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222224': _PreviewMediaSpec(
      ...
      alt: 'Futbol sahası, top ve karar anını temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222225': _PreviewMediaSpec(
      ...
      alt: 'Kamu belgesi, bina ve görünürlük fikrini temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222226': _PreviewMediaSpec(
      ...
      alt: 'Ev ve iş alanlarını bağlayan çalışma düzenini temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222227': _PreviewMediaSpec(
      ...
      alt: 'Uçak kabini, yan yana koltuklar ve aile bütünlüğünü temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222228': _PreviewMediaSpec(
      ...
      alt: 'İnsan, yapay zekâ ve yeniden öğrenme geçişini temsil eden soyut KEFE illüstrasyonu.',
    ),
    '22222222-2222-4222-8222-222222222229': _PreviewMediaSpec(
      ...
      alt: 'Kitap, mezuniyet başlığı ve yapay zekâ sembollerini temsil eden soyut KEFE illüstrasyonu.',
    ),
  };
