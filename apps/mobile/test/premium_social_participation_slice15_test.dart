...
void main() {
  test('slice 15 contract locks post-Commit social participation boundaries', () {
    ...
    final postCommit = contract['post_commit_boundary']!
  ...
  testWidgets('Community Reasons remains hidden while its feature gate is off', (
    tester,
  ) async {
  ...
  testWidgets('existing Consensus submit and Community publish flows remain intact', (
    tester,
  ) async {
    ...
    await tester.tap(find.byKey(const ValueKey('community-reason-tag-FAIRNESS')));
    await tester.pump();
